...
- Verify `.neurond/specs/$1/requirements.md` exists
...
- .neurond/steering/*.md
- .neurond/settings/rules/design-*.md
- .neurond/settings/templates/specs/design.md
- .neurond/settings/templates/specs/research.md
...
**If Design Approved**:
- Review generated design at `.neurond/specs/$1/design.md`
- **Optional**: Run `/neurond:validate-design $1` for interactive quality review
- Then `/neurond:spec-tasks $1 -y` to generate implementation tasks

**If Modifications Needed**:
- Provide feedback and re-run `/neurond:spec-design $1`
