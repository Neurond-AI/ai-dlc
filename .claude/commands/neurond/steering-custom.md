...
# Neurond Custom Steering Creation
...
- .neurond/settings/templates/steering-custom/*.md
...
Available templates in `.neurond/settings/templates/steering-custom/`:
...
- `.neurond/settings/` content should NOT be documented (it's metadata, not project knowledge)
