...
- .neurond/specs/$1/design.md
- .neurond/steering/*.md
- .neurond/settings/rules/design-review.md
"""
)
```
...
- Run `/neurond:spec-tasks $1` to generate implementation tasks
- Or `/neurond:spec-tasks $1 -y` to auto-approve and proceed directly

**If Design Needs Revision (NO-GO Decision)**:
- Address critical issues identified
- Re-run `/neurond:spec-design $1` with improvements
- Re-validate with `/neurond:validate-design $1`
