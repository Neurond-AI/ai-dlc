...
- .neurond/steering/*.md
- .neurond/settings/rules/gap-analysis.md
"""
)
```
...
- Run `/neurond:spec-design $1` to create technical design document
- Or `/neurond:spec-design $1 -y` to auto-approve requirements and proceed directly
