...
- Parse conversation history for `/neurond:spec-impl <feature> [tasks]` patterns
- OR scan `.neurond/specs/*/tasks.md` for `[x]` checkboxes
- Pass detected features and tasks to Subagent

**If feature only** (`$1` present, `$2` empty):
- Read `.neurond/specs/$1/tasks.md` and find all `[x]` checkboxes
...
- Re-run `/neurond:spec-impl <feature> [tasks]` for fixes
- Re-validate with `/neurond:validate-impl [feature] [tasks]`
