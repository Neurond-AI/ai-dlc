...
- Verify `.neurond/specs/$1/tasks.md` exists
...
- Otherwise: Read `.neurond/specs/$1/tasks.md` and find all unchecked tasks (`- [ ]`)
...
- `/neurond:spec-impl $1 1.1` - Single task
- `/neurond:spec-impl $1 1,2,3` - Multiple tasks

**Execute all pending**:
- `/neurond:spec-impl $1` - All unchecked tasks
