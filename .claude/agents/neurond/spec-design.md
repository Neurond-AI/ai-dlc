...
- Glob(`.neurond/steering/*.md`) to get all steering files
...
- `.neurond/specs/{feature}/spec.json`, `requirements.md`, `design.md` (if exists)
- **Entire `.neurond/steering/` directory** for complete project memory
- `.neurond/settings/templates/specs/design.md` for document structure
- `.neurond/settings/rules/design-principles.md` for design principles
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `.neurond/settings/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `.neurond/settings/rules/design-discovery-light.md`
...
1. **Load Design Template and Rules**:
   - Read `.neurond/settings/templates/specs/design.md` for structure
   - Read `.neurond/settings/rules/design-principles.md` for principles
...
1. **Status**: Confirm design document generated at `.neurond/specs/{feature}/design.md`
...
**Note**: The actual design document follows `.neurond/settings/templates/specs/design.md` structure.
...
- **Suggested Action**: "Run `/neurond:spec-design {feature} -y` to auto-approve requirements and proceed"

**Missing Requirements**:
- **Stop Execution**: Requirements document must exist
- **User Message**: "No requirements.md found at `.neurond/specs/{feature}/requirements.md`"
- **Suggested Action**: "Run `/neurond:spec-requirements {feature}` to generate requirements first"

**Template Missing**:
- **User Message**: "Template file missing at `.neurond/settings/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`.neurond/settings/rules/design-discovery-full.md`)
