...
- `.neurond/specs/{feature}/spec.json`, `requirements.md`, `design.md`, `tasks.md`
...
- **Suggested Action**: "Complete previous phases: `/neurond:spec-requirements`, `/neurond:spec-design`, `/neurond:spec-tasks`"
