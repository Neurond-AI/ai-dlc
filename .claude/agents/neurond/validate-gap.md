...
2. **Read Analysis Guidelines**:
   - Read `.neurond/settings/rules/gap-analysis.md` for comprehensive analysis framework
...
### Error Scenarios
- **Missing Requirements**: If requirements.md doesn't exist, stop with message: "Run `/neurond:spec-requirements {feature}` first to generate requirements"
