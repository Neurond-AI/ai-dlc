...
1. **Load Context**:
   ...
   - Read `.neurond/specs/{feature}/requirements.md` for project description
...
2. **Read Guidelines**:
   - Read `.neurond/settings/rules/ears-format.md` for EARS syntax rules
   - Read `.neurond/settings/templates/specs/requirements.md` for document structure
